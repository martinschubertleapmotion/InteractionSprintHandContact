...
////// Specular:
                ...
                float3 diffuseColor = max(max(max(_Texture_BaseDiffuse_var.rgb,node_7794),((_MiddleGradientAmount*1.0+-1.0)+(node_8782.r*_GradientColor.rgb))),((_ThumbGradientAmount*1.0+-1.0)+(node_6148.r*_GradientColor.rgb))); // Need this for specular when using metallic
...
////// Emissive:
                float3 emissive = max(max(max(node_7794,_EmissionBase.rgb),((_MiddleGradientAmount*1.0+-1.0)+(node_8782.r*_GradientColor.rgb))),((_ThumbGradientAmount*1.0+-1.0)+(node_6148.r*_GradientColor.rgb)));
/// Final Color:
