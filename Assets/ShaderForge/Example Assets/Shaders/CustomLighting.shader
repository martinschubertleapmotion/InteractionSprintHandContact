...
Shader "Shader Forge/Examples/Custom Lighting" {
    Properties {
        ...
        _node_1824 ("node_1824", Range(0, 0.1)) = 0.03504274
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.pos = UnityObjectToClipPos( float4(v.vertex.xyz + v.normal*_node_1824,1) );
                return o;
            }
